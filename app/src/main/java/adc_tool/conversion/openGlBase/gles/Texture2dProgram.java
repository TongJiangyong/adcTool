...
//FBO add
public int[] getrameBufferTextures(){
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            //这里是传递不同的GLSL语言.....使用不同类型的片段着色器用来create着色器程序，顶点着色器还是一致的
            case TEXTURE_2D:
     ...
     *
     * @param mvpMatrix The 4x4 projection matrix.  //mvpMatrix这里实际上是一个视图投影矩阵，即混合了视图和投影两个过程
     ...
     *        for use with SurfaceTexture.)  //mvpMatrix是纹理坐标到实际坐标的映射矩阵
